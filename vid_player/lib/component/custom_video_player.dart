...
enum VideoRenderingMode { aspectRatio, stretch, cropToFit }
...
class _CustomVideoPlayerState extends State<CustomVideoPlayer> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Container( // This Container wraps the video player to allow for stretching.
  ...
  Widget _buildVideoPlayer() {
    ...
    switch (_renderingMode) {
      ...
      case VideoRenderingMode.stretch:
      // Stretch mode to fill the screen
        return Container(
          width: double.infinity,
          height: double.infinity,
          child: videoPlayerWidget,
        );
      case VideoRenderingMode.cropToFit:
      // Crop to fit mode
        return Container(
          width: double.infinity,
          height: double.infinity,
